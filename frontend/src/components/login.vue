    ...
    <main class="flex w-full justify-center items-center h-[calc(100vh-4.5rem)]">
        <div class="introduction w-3/5 bg-[url(../public/bg.jpg)] bg-cover h-full">
            <h1 class="text-3xl text-white italic pr-64 pl-16 pt-42">
                If a program is designed to think, but only within the boundaries of its code, is it truly intelligent —
                or just a prisoner of logic, unaware of the world beyond its loops and algorithms?
            </h1>
        </div>
        <div class="flex justify-center px-auto bg-white w-2/5 h-full items-center">
            <div class="flex-col w-128">
                <div class="py-4 px-8 text">
                    ...
                    <p class="text-gray-700">Don't have an account? <router-link to="/register"
                            class="text-indigo-500 hover:underline font-bold">Create a new account here!</router-link>
                    </p>
                ...
                <div class="py-4 px-8 rounded w-full">
                    <form @submit.prevent="loginUser">
                        <div class="mb-4">
                            <label for="email"
                                class="block text-gray-700 text-sm font-bold mb-2 select-none">Email</label>
